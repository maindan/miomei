...
public enum MiomeiWordmarkMetrics {
    public static let designSize = CGSize(width: 1267, height: 270)
}
...
public struct MiomeiMioShape: Shape {
    public static let designSize = MiomeiWordmarkMetrics.designSize
...
public struct MiomeiMeiShape: Shape {
    public static let designSize = MiomeiWordmarkMetrics.designSize
