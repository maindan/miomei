...
struct MiomeiLogo: View {
    enum DrawEasing: String, CaseIterable, Sendable {
    ...
    var body: some View {
        ZStack {
            ...
            MiomeiMeiShape()
                ...
                .stroke(Color.miomeiOrange, style: StrokeStyle(lineWidth: strokeWidth, lineCap: .round, lineJoin: .round))
        }
    }
}
